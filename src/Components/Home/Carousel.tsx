...
const carouselData=[
    {
        ...
        description:'Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet nisut sint inventore rem debitis architecto quas aut fugit ipsa',
        img:carouselImg1,
    },
    {
