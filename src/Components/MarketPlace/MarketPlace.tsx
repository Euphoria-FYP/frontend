            ...
            <div className=" flex flex-wrap gap-2 w-full">
              <button
                className={` rounded-lg ${
                  category === "Sports" ? `bg-[#7000ff]` : `bg-[#1e1e23]`
                } text-sm py-2 px-4 `}
                onClick={() => tagsFilter("Sports")}
              >
                Sports
              </button>
              <button
                className={` rounded-lg  ${
                  category === "Music" ? `bg-[#7000ff]` : `bg-[#1e1e23]`
                } text-sm py-2 px-4 `}
                onClick={() => tagsFilter("Music")}
              >
                Music
              </button>
              <button
                className={` rounded-lg  ${
                  category === "Art" ? `bg-[#7000ff]` : `bg-[#1e1e23]`
                } text-sm py-2 px-4 `}
                onClick={() => tagsFilter("Art")}
              >
                Art
              </button>
              <button
                className={` rounded-lg  ${
                  category === "Game" ? `bg-[#7000ff]` : `bg-[#1e1e23]`
                } text-sm py-2 px-4 `}
                onClick={() => tagsFilter("Game")}
              >
                Game
              </button>
              <button
                className={` rounded-lg  ${
                  category === "Painting" ? `bg-[#7000ff]` : `bg-[#1e1e23]`
                } text-sm py-2 px-4 `}
                onClick={() => tagsFilter("Painting")}
              >
                Painting
              </button>
            </div>
